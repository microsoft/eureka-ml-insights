...
class FindFunctionPathTest(unittest.TestCase):
    ...
    def test_find_function_at_module_level(self):
        ...
        result = python_code_utils.find_function_path(src_code, "my_function")
    ...
    def test_function_not_found(self):
        ...
        with self.assertRaisesRegex(
            ...
            python_code_utils.find_function_path(src_code, "my_function")
    ...
    def test_multiple_functions_found(self):
        ...
        """)
        with self.assertRaisesRegex(
            python_code_utils.AmbiguousFunctionNameError,
    ...
    def test_valid_code(self):
        ...
        src_code = textwrap.dedent("""
            def my_function():
                return 42
        """)
        is_valid, error_message = python_code_utils.is_python_code_valid(src_code)
