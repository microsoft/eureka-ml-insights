...
class EULER_PIPELINE(ExperimentConfig):
    """This class specifies the config for running EULER benchmark on any model"""
    ...
    def configure_pipeline(
        ...
        self.data_processing_comp = PromptProcessingConfig(
            ...
            prompt_template_path=os.path.join(
                os.path.dirname(__file__), "../prompt_templates/euler_templates/Template_1clean.jinja"
            ),
        ...
        self.data_post_processing_addmv = DataProcessingConfig(
            ...
            data_reader_config=DataSetConfig(
                DataReader,
                {
                    ...
                    "transform": SequenceTransform(
                        [
                            MajorityVoteTransform(id_col="data_point_id",model_output_col=answer_col),
                            ColumnRename(
                                name_mapping={
...
class EULER_HYBRIDEXTRACT_PIPELINE(EULER_PIPELINE):
    """This class specifies the config for running EULER with a hybrid answer extraction"""
    ...
    def configure_pipeline(
        ...
        self.llm_extraction_subpipeline = llm_extraction_subpipeline_conf.configure_subpipeline(
            ...
            llm_extraction_prompt_template=os.path.join(
                ...
                "../prompt_templates/euler_templates/extract_euler_answer.jinja",
            ),
