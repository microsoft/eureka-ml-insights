...
class LIVE_CODE_BENCH_CODEGEN_PIPELINE(configs.ExperimentConfig):
    ...
    def _create_code_eval_config(
        ...
        Evaluates the code on test cases and generates the main report.
    ...
    def _create_best_of_n_eval_config(
        ...
        return configs.EvalReportingConfig(
            ...
            aggregator_configs=[
                ...
                # Calculates average best-of-n accuracy by difficulty level (
                # n = num_repeats).
                config.AggregatorConfig(
                    class_name=reports.BiLevelAggregator,
                    init_args={
                        ...
                        "agg_fn": "max",
                        "second_groupby": self._DIFFICULTY_LEVEL_COLUMN_NAME,
                        "filename_base": "BestOfN_ByDifficulty",
                    }
                ),
    ...
    def _create_worst_of_n_eval_config(
        ...
        return configs.EvalReportingConfig(
            ...
            aggregator_configs=[
                ...
                # Calculates overall average worst-of-n accuracy (
                # n = num_repeats).
                config.AggregatorConfig(
                    class_name=reports.BiLevelAggregator,
                    init_args={
