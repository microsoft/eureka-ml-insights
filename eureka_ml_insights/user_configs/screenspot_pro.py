...
class SCREENSPOT_PRO_PIPELINE(ExperimentConfig):
    """
    This defines an ExperimentConfig pipeline for the SCREENSPOT_PRO dataset.
    ...
    def configure_pipeline(self, model_config: ModelConfig, resume_from: str = None, **kwargs: dict[str, Any] ) -> PipelineConfig:
        ...
        data_reader_config=DataSetConfig(
            DataReader,
            {
                "path": "/mnt/phimmwestus3_datasets/EVAL/ScreenSpotPro/annotations/android_studio_macos.json",                
        ...
        prompt_template_path=os.path.join(
            os.path.dirname(__file__), "../prompt_templates/screenspot_pro_templates/basic.jinja"
        ),          
