...
from eureka_ml_insights.metrics import CountAggregator, NPHardMetricSAT
...
class NPHARD_SAT_PIPELINE(ExperimentConfig):
    def configure_pipeline(
            ...
            data_reader_config=DataSetConfig(
                HFDataReader,
                {
                    ...
                    "transform": SequenceTransform(
                        [
                            ColumnRename(name_mapping={"query_text": "prompt", "solution": "ground_truth"}),
                        ]
                    ),
                },
            ),
        ...
        inference_comp = InferenceConfig(
            ...
            resume_from="/home/vivineet/projects/evaluation/NPHardEval/SAT/eureka-ml-insights/logs/NPHARD_SAT_PIPELINE/nphard_tsp/2024-12-15-20-53-08.666326/inference_result/inference_result.jsonl",
        )
        ...
        evalreporting_comp = EvalReportingConfig(
            ...
            metric_config=MetricConfig(NPHardMetricSAT),
            aggregator_configs=[
                AggregatorConfig(CountAggregator, {"column_names": ["NPHardMetricSAT_result"], "normalize": True}),
                # AggregatorConfig(
                #     CountAggregator,
