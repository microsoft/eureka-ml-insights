...
class AzureMMDataLoader(MMDataLoader):
    ...
    def __init__(
        ...
        self.container_client = ContainerClient(
            ...
            credential=ManagedIdentityCredential(client_id="205cb331-87f7-4e09-a6dd-70715dec87ec"),
            logger=self.logger,
        )
...
class AzureBlobReader:
    ...
    def read_azure_blob(self, blob_url) -> str:
        ...
        """
        blob_client = BlobClient.from_blob_url(blob_url, credential=ManagedIdentityCredential(client_id="205cb331-87f7-4e09-a6dd-70715dec87ec"), logger=self.logger)
