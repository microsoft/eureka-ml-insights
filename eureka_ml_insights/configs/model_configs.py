...
VLLM_PHI_4_RL_APRIL_2025_CONFIG_30K = ModelConfig(
...
VLLM_PHI_4_RL_APRIL_2025_CONFIG_30K_SMALL_T = ModelConfig(
    # Use this config if you have already deployed the model
    # and pass the service ports, num_servers, and model_name as commandline args
    LocalVLLMModel,
    {
...
VLLM_PHI_4_SFT_APRIL_2025_CONFIG_30K = ModelConfig(
    # Use this config if you have already deployed the model
    # and pass the service ports, num_servers, and model_name as commandline args
    LocalVLLMModel,
    {
...
VLLM_PHI_4_SFT_APRIL_2025_CONFIG_25K = ModelConfig(
    # Use this config if you have already deployed the model
    # and pass the service ports, num_servers, and model_name as commandline args
    LocalVLLMModel,
    {
